...
describe('Service Tests', () => {
    ...
    describe('FinansalHareketDetay Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(FinansalHareketDetayService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/finansal-hareket-detays';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return FinansalHareketDetay', () => {
