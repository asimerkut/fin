...
import 'pivottable/dist/export_renderers.min.js';
// import 'pivottable/dist/d3_renderers.min.js';
...
export class DefPivotDetailComponent implements OnInit, OnDestroy, AfterViewInit {
    ...
    ngAfterViewInit() {
        ...
        const pderivers = $.pivotUtilities.derivers;
        const prenderers = $.extend(
