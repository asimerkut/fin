...
describe('Service Tests', () => {
    ...
    describe('HopFinansalHareketDetay Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(HopFinansalHareketDetayService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/hop-finansal-hareket-detays';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return HopFinansalHareketDetay', () => {
