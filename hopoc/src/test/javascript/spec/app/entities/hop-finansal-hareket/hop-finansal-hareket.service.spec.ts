...
describe('Service Tests', () => {
    ...
    describe('HopFinansalHareket Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(HopFinansalHareketService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/hop-finansal-harekets';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return HopFinansalHareket', () => {
